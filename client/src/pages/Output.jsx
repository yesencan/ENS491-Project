...
const Output = () => {
  ...
  const [filteredList, setFilteredList] = useState(OutputData.results);
  ...
  const handleSearch = (e, type) => {
    ...
    console.log(text);
    if (type === "GeneID") {
      OutputData.results.forEach((item) => {
        console.log(item);
        if (text === "") {
          filteredList.push(item);
        } else if (
          item.geneId.toLowerCase().toString().includes(text.toLowerCase())
        ) {
          filteredList.push(item);
        }
      });
    ...
    if (type === "Position") {
      OutputData.results.forEach((item) => {
        ...
        if (text === "") {
          ...
          item.position.toLowerCase().toString().includes(text.toLowerCase())
        ) {
          filteredList.push(item);
        }
      });
    ...
    if (type === "Phosphate") {
      OutputData.results.forEach((item) => {
        ...
        if (text === "") {
          ...
          item.proteinSeq.toLowerCase().toString().includes(text.toLowerCase())
        ) {
          filteredList.push(item);
        }
      });
    ...
    if (type === "Kinase") {
      OutputData.results.forEach((item) => {
        ...
        if (text === "") {
          ...
          item.probKinase.toLowerCase().toString().includes(text.toLowerCase())
        ) {
          filteredList.push(item);
        }
      });
    ...
    if (type === "Probability") {
      OutputData.results.forEach((item) => {
        ...
        if (text === "") {
          ...
          item.probability.toLowerCase().toString().includes(text.toLowerCase())
        ) {
          filteredList.push(item);
        }
      });
